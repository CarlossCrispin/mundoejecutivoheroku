...
router.get('/users/jobGraph', controllers.userController.getJobGraph)
router.get('/users/user',AuthMiddleware.isLogged, controllers.userController.getUser)
router.get('/users/info',AuthMiddleware.isLogged, controllers.userController.getInfo);
router.get('/users/incomeGraph', controllers.userController.getIncomeGraph)
router.get('/users/sectorGraph', controllers.userController.getSectorGraph)
